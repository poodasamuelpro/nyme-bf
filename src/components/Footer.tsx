...
export default function Footer() {
  return (
    <footer className="relative bg-nyme-primary-dark border-t border-nyme-orange/15 overflow-hidden">
      {/* Décors lumineux */}
      <div className="absolute top-0 left-1/4 w-64 sm:w-96 h-64 sm:h-96 rounded-full bg-nyme-orange/8 blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-48 sm:w-64 h-48 sm:h-64 rounded-full bg-nyme-blue-light/12 blur-3xl pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-5 gap-8 sm:gap-10">
          ...
          <div className="col-span-2 lg:col-span-2">
            ...
            <div className="space-y-2.5">
              <div className="flex items-center gap-2 text-white/50 text-xs sm:text-sm font-body">
                <MapPin size={13} className="text-nyme-orange shrink-0" />
                <span>Ouagadougou, Burkina Faso</span>
              </div>
              <a href="tel:+22600000000" className="flex items-center gap-2 text-white/50 text-xs sm:text-sm hover:text-nyme-orange transition-colors font-body">
                <Phone size={13} className="text-nyme-orange shrink-0" />
                <span>+226 00 00 00 00</span>
              </a>
              <a href="mailto:nyme.contact@gmail.com" className="flex items-center gap-2 text-white/50 text-xs sm:text-sm hover:text-nyme-orange transition-colors font-body">
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              {[
                ...
                <li key={href}>
                  <Link href={href} className="text-white/50 text-xs sm:text-sm hover:text-nyme-orange transition-colors font-body">
                    {label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              {[
                ...
                ['/contact#partenaires',       'Partenariats'],
              ].map(([href, label]) => (
                <li key={href}>
                  <Link
                    href={href}
                    className={`text-xs sm:text-sm transition-colors font-body ${
                      label === 'Espace partenaires'
                        ? 'text-nyme-orange/80 hover:text-nyme-orange font-medium'
                        : 'text-white/50 hover:text-nyme-orange'
                    }`}
                  >
                    {label}
                  </Link>
        ...
        <div className="mt-10 sm:mt-12 pt-6 sm:pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-6">
            <a href="mailto:nyme.contact@gmail.com" className="text-white/30 text-[10px] sm:text-xs font-body hover:text-nyme-orange transition-colors">
              nyme.contact@gmail.com
            </a>
            <div className="flex items-center gap-2">
              <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-green-400 animate-pulse" />
              <span className="text-white/30 text-[10px] sm:text-xs font-body">Application en développement</span>
            </div>
          </div>
        </div>
      </div>
