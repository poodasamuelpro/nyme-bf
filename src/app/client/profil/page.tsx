...
export default function ProfilPage() {
  ...
  // Seuls les champs modifiables présents dans la table utilisateurs
  ...
  const handleSave = async () => {
    ...
    setSubmitting(true)
    try {
      // updated_at géré par le trigger utilisateurs_updated_at côté Supabase
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="flex items-center gap-3 h-16">
            ...
            <div>
              ...
              <p className="text-white/60 text-xs">Gérez vos informations</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8 pb-24 space-y-6">
        ...
        {!editing ? (
          <div className="space-y-3">
            ...
            <div className="bg-white rounded-2xl p-4 shadow-sm">
              ...
              <p className="font-semibold text-gray-900">⭐ {user.note_moyenne || 0} / 5</p>
            </div>
        ...
        <div className="space-y-2">
          {[
            ...
            { href: '/client/contacts-favoris',  label: '👥 Contacts favoris' },
          ].map(item => (
